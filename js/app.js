(() => {
    ...
    function initSliders() {
        if (document.querySelector(".review__slider")) new Swiper(".review__slider", {
            ...
            speed: 800,
            navigation: {
                prevEl: ".review__navigation .swiper-button-prev",
                nextEl: ".review__navigation .swiper-button-next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1,
    ...
    document.addEventListener("click", (e => {
        const targetEl = e.target;
        if (targetEl.closest(".menu-wrap__btn") && window.innerWidth > 849.98) removeClasses(document.querySelectorAll(".menu-wrap__item.dropdown-open"), "dropdown-open");
        if (targetEl.closest(".menu-wrap__btn")) targetEl.closest(".menu-wrap__item").classList.toggle("dropdown-open");
        if (!targetEl.closest(".menu-wrap__btn") && document.querySelectorAll(".menu-wrap__item.dropdown-open").length > 0) removeClasses(document.querySelectorAll(".menu-wrap__item.dropdown-open"), "dropdown-open");
        if (targetEl.closest(".item-popup__btn")) targetEl.closest(".item-popup").classList.toggle("active");
        if (targetEl.closest(".body-form__click")) document.querySelector(".coupon-form").classList.add("active");
    }));
    isWebp();
    menuInit();
    fullVHfix();
